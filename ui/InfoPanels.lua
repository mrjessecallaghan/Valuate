...
local function CreateChangelogPanel(parent)
    ...
    -- Version 0.90.0a (Current) - see CHANGELOG.md for the release-by-release detail.
    --
    ...
    local vCurrentHeader = CreateVersionHeader("Version 0.90.0a (Current) - what is new since 0.17.2a", currentY)
    currentY = currentY - lineHeight - paragraphSpacing
