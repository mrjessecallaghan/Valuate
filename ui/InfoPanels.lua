...
local function CreateChangelogPanel(parent)
    ...
    -- Version 0.38.5a (Current) - see CHANGELOG.md for the release-by-release detail.
    --
    ...
    local vCurrentHeader = CreateVersionHeader("Version 0.38.5a (Current) - what is new since 0.17.2a", currentY)
    currentY = currentY - lineHeight - paragraphSpacing
