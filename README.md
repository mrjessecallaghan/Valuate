...
> **This is a fork.** Branch `claude-fork`, currently **v0.125.0a**, substantially diverged
...
Developed without the game running. **47 subsystems execute real Lua** headlessly against a
...
47 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
