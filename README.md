...
> **This is a fork.** Branch `claude-fork`, currently **v0.206.0a**, substantially diverged
...
Developed without the game running. **74 subsystems execute real Lua** headlessly against a
...
74 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
