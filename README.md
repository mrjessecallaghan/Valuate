...
> **This is a fork.** Branch `claude-fork`, currently **v0.119.1a**, substantially diverged
...
Developed without the game running. **44 subsystems execute real Lua** headlessly against a
...
44 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
