...
> **This is a fork.** Branch `claude-fork`, currently **v0.202.0a**, substantially diverged
...
Developed without the game running. **71 subsystems execute real Lua** headlessly against a
...
71 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
