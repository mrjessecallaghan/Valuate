...
> **This is a fork.** Branch `claude-fork`, currently **v0.49.2a**, substantially diverged
...
Developed without the game running. 12 subsystems are executed headlessly against a mocked
...
comparison text, the upgrade-arrow driver, the stat-share ranking, and the Settings keybind capture.
...
12 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
