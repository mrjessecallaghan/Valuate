...
> **This is a fork.** Branch `claude-fork`, currently **v0.103.1a**, substantially diverged
...
Developed without the game running. **36 subsystems execute real Lua** headlessly against a
...
in 51 specific ways and requires the matching gate to fail for each. A `SURVIVED` line means an
...
36 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
