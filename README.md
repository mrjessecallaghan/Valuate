...
> **This is a fork.** Branch `claude-fork`, currently **v0.188.0a**, substantially diverged
...
Developed without the game running. **67 subsystems execute real Lua** headlessly against a
...
67 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
