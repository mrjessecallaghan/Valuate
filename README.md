...
> **This is a fork.** Branch `claude-fork`, currently **v0.177.2a**, substantially diverged
...
Developed without the game running. **60 subsystems execute real Lua** headlessly against a
...
60 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
