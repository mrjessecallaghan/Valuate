...
> **This is a fork.** Branch `claude-fork`, currently **v0.50.1a**, substantially diverged
...
Developed without the game running. 14 subsystems are executed headlessly against a mocked
...
comparison text, the upgrade-arrow driver, the stat-share ranking, the Settings keybind capture, tab switching, and the confirm dialog.
...
14 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
