...
> **This is a fork.** Branch `claude-fork`, currently **v0.50.0a**, substantially diverged
...
Developed without the game running. 13 subsystems are executed headlessly against a mocked
...
comparison text, the upgrade-arrow driver, the stat-share ranking, the Settings keybind capture, and tab switching.
...
13 of them **execute real Lua** under fengari against a mocked WoW API (listed under *Status*
