...
`verifytest.js`, `deletetest.js`, `scalelisttest.js`, `bestequiptest.js`, `tooltiptest.js`, `arrowtest.js`. These 10 *execute real Lua* under fengari against a mocked WoW API
